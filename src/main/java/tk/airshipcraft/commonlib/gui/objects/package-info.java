/**
 * <p>Holds the essential objects and interfaces for the GUI system's various components,
 * such as scoreboards, boss bars, and other custom UI elements.</p>
 *
 * <h2>Subpackages:</h2>
 * <ul>
 ...
 * </ul>
 *
 * <p>Use these objects to construct and control the various aspects of in-game display elements.</p>
 *
 * @author notzune
 * @version 1.0.0
 * @since 2023-11-20
